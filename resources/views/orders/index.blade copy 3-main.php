...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '.edit-order-btn', function() {
            ...
            // 3. Disable the select so the user cannot change it
            select.prop('disabled', true);
            // 4. Update the hidden input (This ensures the ID is sent to the server)
            $('#hidden_client_id').val(data.clientId);
