    ...
    <div class="invoice-box">
        <div class="brand-header">
            <div class="row align-items-end">
                <div class="col-8">
                    <img src="{{ asset('images/logo.png') }}" style="max-height: 75px; margin-bottom: 10px;" alt="Logo">
                    <!-- <div class="small text-muted">مطبعة أبوكويك</div> -->
                </div>
                ...
                <div class="col-6 text-start">
                    <div class="info-box ps-5">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <span class="fw-bold small">شيكل (ILS)</span>
                        </div>
                    </div>
                </div>
            </div>
